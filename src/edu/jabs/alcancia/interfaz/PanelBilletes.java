...
public class PanelBilletes extends JPanel implements ActionListener, ItemListener{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------

    /**
     * Constante para agregar un Billete a la alcancía.
     */
    ...
    /**
     * Opción para seleccionar Billetes de $20.
     */
    private JRadioButton radio20;

    /**
     * Opción para seleccionar Billetes de $50.
     */
    private JRadioButton bille50;

    /**
     * Opción para seleccionar Billetes de $100.
     */
    private JRadioButton radio100;

    /**
     * Opción para seleccionar Billetes de $200.
     */
    private JRadioButton radio200;

        /**
     * Opción para seleccionar Billetes de $500.
     */
    private JRadioButton bille500;

    /**
     * Opción para seleccionar Billetes de $1000.
     */
    private JRadioButton radio1000;

    /**
     * Grupo de botones que asegura que solamente se selecciona un Billete a la vez.
     */
    private ButtonGroup grupoBotones;

    /**
     * Botón para agregar un Billete a la alcancía.
     */
     ...
     */
    public PanelBilletes( InterfazAlcancia pPrincipal )
    {
        ...
        radio20 = new JRadioButton( "0", new ImageIcon( "./data/20.png" ) );
        ...
        bille50 = new JRadioButton( "0", new ImageIcon( "./data/50.png" ) );
        grupoBotones.add( bille50 );
        bille50.setVerticalTextPosition( SwingConstants.BOTTOM );
        bille50.setHorizontalTextPosition( SwingConstants.CENTER );
        bille50.addItemListener( this );
        bille50.setBorder( null );
        add( bille50 );
        ...
        bille500 = new JRadioButton( "0", new ImageIcon( "./data/500.png" ) );
        grupoBotones.add( bille500 );
        bille500.setVerticalTextPosition( SwingConstants.BOTTOM );
        bille500.setHorizontalTextPosition( SwingConstants.CENTER );
        bille500.addItemListener( this );
        bille500.setBorder( null );
        add( bille500 );
        ...
        setBorder( new TitledBorder( "Billetes" ) );
    }
    ...
    /**
     * Cambia la cantidad de Billetes que hay de una cierta cantidad.
     * @param pDenominacion Denominación del billete. pDenominacion>0.
     * @param pCantidad Cantidad de esas Billetes que hay. pCantidad>0.
     */
    public void cambiarCantidad( int pDenominacion, int pCantidad )
    {
        if( pDenominacion == 20 )
        {
            radio20.setText( "" + pCantidad );
        }
        else if( pDenominacion == 50 )
        {
            bille50.setText( "" + pCantidad );
        }
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( AGREGAR.equals( comando ) )
        {
            ...
            principal.agregarBillete( denominacion);
        }
    }
